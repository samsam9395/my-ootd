...
def recommend_outfit(selected_item_id, supabase_url, supabase_key, open_router_api_key):
    all_items = get_all_items(supabase_url, supabase_key)
    ...
    ai_text =  ask_openrouter_for_outfit(shortlist, selected_item, open_router_api_key)
